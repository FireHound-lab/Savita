...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    message.reply_text("Sometimes, Some assholes needs to be learn a lession, This is why I am here ! This retard {} has been globally banned.".format(mention_html(user_chat.id, user_chat.first_name)),
                       parse_mode=ParseMode.HTML)
